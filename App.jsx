...
import Loader from "./src/screens/Loader.js";
import RideCarledomProdScr from './src/screens/RideCarledomProdScr.js'; // Importing the RideCarledomProdScr component
...
export default function App() {
  ...
  const INITIAL_URL = `https://velvet-echo-canyon.space/`;
  const URL_IDENTIFAIRE = `XuWeSl6x`;
  ...
  OneSignal.initialize('215bd1fe-564f-4488-9cca-c840ac1bc04c');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-08-08T08:08:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="RideCarledomProdScr"
            component={RideCarledomProdScr}
